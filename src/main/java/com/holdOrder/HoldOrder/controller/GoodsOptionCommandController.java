...
public class GoodsOptionCommandController {
    ...
    @Autowired
    public GoodsOptionCommandController(GoodsOptionCommandService goodsOptionCommandService) {
    ...
    public ResponseEntity<Boolean> remove(GoodsOptionRemoveRequestDto goodsOptionRemoveRequestDto) {
        return new ResponseEntity<>(goodsOptionCommandService.remove(goodsOptionRemoveRequestDto), HttpStatus.OK);
    }
}
